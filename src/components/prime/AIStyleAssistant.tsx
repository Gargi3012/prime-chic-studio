...
import { X, Send, Sparkles, ShoppingBag, Eye } from "lucide-react";
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-end p-2 sm:p-6">
          ...
          <motion.div
            ...
            className="relative flex h-[520px] w-full max-w-md flex-col overflow-hidden rounded-3xl border border-gold/40 bg-surface-2 shadow-2xl text-foreground z-10"
          >
            {/* Top Header */}
